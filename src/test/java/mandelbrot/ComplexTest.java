...
public class ComplexTest {
    ...
    void testSquaredModulus(){
        assertEquals(2.0, new Complex(1,1).squaredModulus());
    ...
    void testComplexReal(){
        ...
        assertEquals(new Complex(8,0), Complex.real(8));
    }

    @Test
    void testAdd(){
        assertEquals(Complex.ONE, Complex.ZERO.add(Complex.ONE));
        assertEquals(new Complex(3,4),
                new Complex(3,0).add(new Complex(0,4)));
    }
